...
import { View, StyleSheet, Dimensions, ImageEditor, TouchableHighlight, Image, Text, TouchableOpacity, CameraRoll } from 'react-native';
...
class CameraScreen extends Component {
    constructor(props) {
        super(props);
        this.state = { path: null, type: 'back', };
    }
    ...
    savePhoto() {
        let params = { path: this.state.path }
    ...
    takePicture = async function () {
        if (this.camera) {
            const options = { quality: 1, width: 1000, height: 1000, fixOrientation: true };
